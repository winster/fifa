...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "FIFA.controller.Login": [],
  "FIFA.controller.MainMenu": [],
  "FIFA.model.History": [],
  "FIFA.model.Match": [],
  "FIFA.store.History": [],
  "FIFA.store.Matches": [],
  "FIFA.util.AppConfig": [],
  "FIFA.view.Account": [],
  "FIFA.view.AccountHistory": [],
  "FIFA.view.Casino": [],
  "FIFA.view.ChangePassword": [],
  "FIFA.view.GameFinish": [],
  "FIFA.view.Login": [],
  "FIFA.view.MainMenu": [],
  "FIFA.view.Matches": [],
  "FIFA.view.UserRegistration": []
});
